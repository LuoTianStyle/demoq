		...
		const params = [
			{
				searchColumn,
				searchValue,
				searchOperator: searchColumn === 'name' ? 'like' : '=',
			},
			{ searchColumn: 'folder', searchValue: 1, searchOperator: '=' },
		].concat(dateSearchData);
		...
		<Container>
			...
			<RangePickers
				...
				onChange={(e, dateString) => {
					const beginTime =
						new Date(dateString[0] + ' 00:00:00').getTime() / 1000;
					const endTime =
						new Date(dateString[1] + ' 23:59:59').getTime() / 1000;
					setdateSearchData([
						{
